...
func main() {
	cases := []harness.Case{
		...
		{Name: "rtc", Fn: testRTC},
		{Name: "rtc-after-iop-reset", Fn: testRTCAfterIOPReset},
		{Name: "math-rand", Fn: testMathRand},
		{Name: "memory-layout", Fn: testMemoryLayout},
		{Name: "libc-heap-cap", Fn: testLibcHeapCap},
		{Name: "json-marshal-struct", Fn: testMarshalStruct},
		{Name: "json-unmarshal-struct", Fn: testUnmarshalStruct},
		{Name: "json-unmarshal-interface", Fn: testUnmarshalInterface},
		{Name: "json-unmarshal-map-slice", Fn: testUnmarshalMapSlice},
		{Name: "json-custom-marshaler", Fn: testCustomMarshaler},
		{Name: "json-decoder-stream", Fn: testDecoderStream},
		{Name: "json-indent", Fn: testIndent},
		{Name: "reflect-basics", Fn: testReflectBasics},
		{Name: "big-arith", Fn: testBigArith},
		{Name: "big-perf", Fn: testBigPerf},
		{Name: "crypto-symmetric", Fn: testCryptoSymmetric},
		{Name: "crypto-ecdh", Fn: testCryptoECDH},
		{Name: "crypto-signatures", Fn: testCryptoSignatures},
		{Name: "crypto-x509", Fn: testCryptoX509},
